...
public class JSONService {
    ...
    public JSONService(ModelMapperService modelMapperService, QuestionRepository questionRepository, AnswerRepository answerRepository, LevelRepository levelRepository, CategoryRepository categoryRepository, QuestionService questionService) {
        ...
        try (FileReader reader = new FileReader(filePath + "fileQuestion.json")) {
            ...
            for (QuestionDto q : questions) {
                ...
                if (validation(q, questionDatabase)) {
                    ...
                    if (category == null) {
                        category = categoryRepository.add(modelMapperService.fromCategoryDtoToCategory(q.getCategory()));
                    }

                    Level level = levelRepository.findByName(q.getLevel().getNameLevel()).orElse(null);
                    Question questionBeforeInsert = modelMapperService.fromQuestionDtoToQuestion(q);
                    ...
                    Question question = questionRepository.add(questionBeforeInsert);

                    List<AnswerDto> answersDto = q.getAnswers();
                    for (AnswerDto a : answersDto) {
                        Answer aa = modelMapperService.fromAnswerDtoToAnswer(a);
                        aa.setQuestion(question);
                        if (a.getCorrect()) {
                            aa.setCorrect(true);
                        }
                        answerRepository.add(aa);
                    }
                }
            }
        } catch (Exception e) {
        ...
        try {
            ...
            List<QuestionDto> questions = Arrays.asList(
                    QuestionDto.builder()
                            ...
                            .level(LevelDto.builder().nameLevel(LevelPoint.EASY).build())
                    ...
                    QuestionDto.builder()
                            ...
                            .category(CategoryDto.builder().name("Star Wars").build())
                            .level(LevelDto.builder().nameLevel(LevelPoint.NORMAL).build())
                            .answers(Arrays.asList(
                    ...
                    QuestionDto.builder()
                            ...
                            .category(CategoryDto.builder().name("Star Wars").build())
                            .level(LevelDto.builder().nameLevel(LevelPoint.HARD).build())
                            .answers(Arrays.asList(
